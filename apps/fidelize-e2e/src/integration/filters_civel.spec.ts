...
describe('Filtros', () => {
  it('Deve filtrar por Relevância "Alta"', () => {
    ...
    cy.get('[data-testid=civil-relevance-filter]').click();

    cy.get('[data-testid=civil-relevance-filter-chk-multi-3]').click();

    cy.get('[data-testid=civil-relevance-filter-chk-multi-apply-btn]').click();
  ...
  it('Deve filtrar por Relevância "Média"', () => {
    ...
    cy.get('[data-testid=civil-relevance-filter-chk-multi-2]').click();
  ...
  it('Deve filtrar por Relevância "Baixa"', () => {
    ...
    cy.get('[data-testid=civil-relevance-filter-chk-multi-1]').click();
  ...
  it('Deve filtrar por Relevância "Expirada"', () => {
    ...
    cy.get('[data-testid=civil-relevance-filter-chk-multi-0]').click();
  ...
  it('Deve filtrar por Tipo "Fiança bancária"', () => {
    ...
    cy.get('[data-testid=civil-category-filter]').click();

    cy.get('[data-testid=civil-category-filter-chk-multi-2]').click();

    cy.get('[data-testid=civil-category-filter-chk-multi-apply-btn]').click();
  ...
  it('Deve filtrar por Tipo "Renovação"', () => {
    ...
    cy.get('[data-testid=civil-category-filter-chk-multi-1]').click();
  ...
  it('Deve filtrar Valor IS, com valor minimo vazio e máximo preenchido', () => {
    cy.get('[data-testid=civil-securityAmount-filter]').click();
