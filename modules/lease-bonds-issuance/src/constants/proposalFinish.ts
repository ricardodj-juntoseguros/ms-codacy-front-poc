...
export const PROPOSAL_FINISH_DATA = {
  [ProposalFinishEnum.success]: {
    ...
    description: 'Em alguns instantes você receberá via email sua apólice de seguro e o boleto para pagamento.',
  },
  [ProposalFinishEnum.analysis]: {
    icon: AnalisysIcon,
    title: 'Sua solicitação está em análise',
    description: 'Em breve você receberá o retorno da nossa equipe.',
  },
  [ProposalFinishEnum.sendToApproval]: {
    icon: AnalisysIcon,
    title: 'Sua proposta foi enviada para aprovação do corretor',
    description: 'Após a aprovação, você receberá via e-mail a apólice de seguro e boleto para pagamento.',
  },
};
