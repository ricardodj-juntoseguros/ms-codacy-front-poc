import { responsibleInformationMock } from 'modules/broker-signup-direct/src/__mocks__';
import { store } from '../../../config/store';

import { responsibleInformationSliceActions } from './ResponsibleInformationSlice';
...
describe('ModalitySelectionSlice', () => {
  ...
  it('should be able search modalities by policyholder', async () => {
    ...
    expect(responsibleInformation).toEqual(responsibleInformationMock);
  });
