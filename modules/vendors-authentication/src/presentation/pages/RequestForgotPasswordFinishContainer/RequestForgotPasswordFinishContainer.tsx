  ...
  return (
    <div className={styles['request_forgot_password_finish_container_wrapper']}>
      ...
      <div className={styles['request_forgot_password_finish_box']}>
        ...
        <div className={styles['request_forgot_password_finish_container_information']}><span>Pronto! Se o e-mail informado estiver cadastrado, você receberá instruções para recuperar seu acesso.</span></div>
