    ...
    <div className={styles['first_access_wrapper']}>
        ...
        { showValidation &&
          <div className={styles['first_access_validation_password']}>
            ...
            <div>{renderIconCheckPassword(VALIDATION_MESSAGES.minChar)}<span className={styles[renderStyleRuleChekPassword(VALIDATION_MESSAGES.minChar)]}> Mínimo de 10 caracteres </span></div>
              <div>{renderIconCheckPassword(VALIDATION_MESSAGES.differentEmail)}<span className={styles[renderStyleRuleChekPassword(VALIDATION_MESSAGES.differentEmail)]}> Diferente do e-mail </span></div>
              <div>{renderIconCheckPassword(VALIDATION_MESSAGES.notNumberSequence)}<span className={styles[renderStyleRuleChekPassword(VALIDATION_MESSAGES.notNumberSequence)]}> Sem sequência (123456...) </span></div>
              <div>{renderIconCheckPassword(VALIDATION_MESSAGES.specialChar)}<span className={styles[renderStyleRuleChekPassword(VALIDATION_MESSAGES.specialChar)]}> Um caractere especial (&*ˆ$...) </span></div>
              <div>{renderIconCheckPassword(VALIDATION_MESSAGES.samePasswords)}<span className={styles[renderStyleRuleChekPassword(VALIDATION_MESSAGES.samePasswords)]}> As duas senhas precisam ser iguais </span></div>
              <div>{renderIconCheckPassword(VALIDATION_MESSAGES.min3charDifferent)}<span className={styles[renderStyleRuleChekPassword(VALIDATION_MESSAGES.min3charDifferent)]}> 3 tipos de caracteres diferentes (maiúsculas, minúsculas e números) </span></div>
             </div>
          </div>
        }
         { showTerms &&
